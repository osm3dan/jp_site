...
**2025/3/26. 地震研スプリングスクール「水槽実験・観測・数値計算を通して津波の基礎を学ぶ」を開講しました**

地震研究所の研究体験プログラム「[地震研究所スプリングスクール](https://www.eri.u-tokyo.ac.jp/education/spring_school_2025/)」の一環で、二日間にわたる集中講義「水槽実験・観測・数値計算を通して津波の基礎を学ぶ」を、学部生一名を対象に開講しました。地震研究所が所有する津波実験装置を用いて、津波の生成・伝播・遡上/浸水の全プロセスを再現することができます。さらに実験装置内で水中圧力計を用いて津波波形を記録し、数値計算でその波形を再現する、という「実験」x「観測」x「数値計算」を二日間で学ぶという内容で行いました。毎年同様のプログラムを実施予定です。ご興味ある方はぜひご参加を検討ください。
